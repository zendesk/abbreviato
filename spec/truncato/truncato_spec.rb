  ...
  context "truncating by character count" do
    describe "normal strings" do
      context "with tail" do
        it_should_truncate "no html text with longer length", with: {max_length: 13}, source: "some text", expected: "some text"
        it_should_truncate "no html text with equal length", with: {max_length: 9}, source: "some text", expected: "some text"
      ...
      context "without tail" do
        ...
        it_should_truncate "no html text with equal length", with: {max_length: 9, tail: ""}, source: "some text", expected: "some text"
        it_should_truncate "no html text with shorter length", with: {max_length: 3, tail: ""}, source: "some text", expected: "som"
      end
    end

    describe "html tags structure" do
      it_should_truncate "html text with a tag (counting tags)", with: {max_length: 15}, source: "<p>some text</p>", expected: "<p>some tex...</p>"
    ...
    describe "include tail as part of max_length" do
      it_should_truncate "html text with a tag (counting tail)",
      ...
      it_should_truncate "html text with a tag (counting tail and including tail before final tag)",
    ...
    describe "comment html element" do
      ...
      it_should_truncate "html text with <!-- a comment --> element",
        with: {max_length: 34, comments: true},
        source: "<!-- a comment --><p>some text 1</p>",
        expected: "<!-- a comment --><p>some text...</p>"

      it_should_truncate "html text with <!-- a comment --> element that exceeds the max_length",
        with: {max_length: 11, comments: true},
        source: "<!-- a comment --><p>some text 1</p>",
        expected: "<!-- ...-->"

      it_should_truncate "html text with <!-- a comment --> element with other elements that exceeds max_length",
    ...
    describe "html attributes" do
      ...
      it_should_truncate "html text with 1 attributes counting its size",
      ...
      it_should_truncate "html text with attribute containing entities respecting them",
        with: {max_length: 3, count_tags: false, filtered_attributes: ['attr2']},
        source: "<p attr1='&gt;some'>text</p>",
        expected: "<p attr1='&gt;some'>tex...</p>"

      it_should_truncate "html text with 2 attributes filtering one of them",
      ...
      it_should_truncate "html text with 2 attributes filtering all of them",
    ...
    describe "excluded tags" do
      it_should_truncate "html text with a filtered tag",
        with: {max_length: 90, filtered_tags: %w[img]},
        source: "<p><img/>some text</p>",
        expected: "<p>some text</p>"

      it_should_truncate "html text with a filtered tag with nested tags",
      ...
      it_should_truncate "html text with a filtered tag with nested tags where nested tags are filtered",
  ...
  context "truncating by bytesize" do
    ...
    describe "multi-byte tail" do
      ...
      it_should_truncate "no html text with longer length",
        ...
        source: "𠲖𠲖𠲖𠲖𠲖𠲖𠲖𠲖",
        expected: "𠲖𠲖𠲖𠲖𠲖𠲖𠲖𠲖"
      it_should_truncate "no html text with equal length",
        with: {count_bytes: true, max_length: 9, tail: "𠴕"},
        source: "𠝹𠝹",
        expected: "𠝹𠝹"
      it_should_truncate "no html text with shorter length",
        with: {count_bytes: true, max_length: 9, tail: "𠴕"},
        source: "𠝹𠝹𠝹𠝹",
        expected: "𠝹𠴕"
      it_should_truncate "no html text with shorter length and longer tail",
    ...
    describe "comment html element" do
      ...
      it_should_truncate "html text with <!-- a comment --> element that exceeds the max length",
        with: {count_bytes: true, max_length: 12, comments: true},
        source: "<!-- a comment --><p>some text 1</p>",
        expected: "<!-- a...-->"

      it_should_truncate "html text with <!-- a comment --> element with other elements that exceeds max length",
