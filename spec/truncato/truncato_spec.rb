...
describe "Truncato" do
  ...
  context "truncating by bytesize" do
    ...
    describe "normal strings" do
      it_should_truncate_bytes "no html text with longer length", with: {count_bytes: true, max_length: 13}, source: "some text", expected: "some text"
      it_should_truncate_bytes "no html text with shorter length, no tail", with: {count_bytes: true, max_length: 7, tail: ""}, source: "some text", expected: "some te"
      it_should_truncate_bytes "no html text with shorter length, with tail", with: {count_bytes: true, max_length: 7}, source: "some text", expected: "some..."
    end
    ...
    describe "multi-byte strings" do
      ...
      it_should_truncate_bytes "no html text with longer length", with: {count_bytes: true, max_length: 51, tail: '...'}, source: "𠲖𠲖𠲖𠲖𠲖𠲖𠲖𠲖", expected: "𠲖𠲖𠲖𠲖𠲖𠲖𠲖𠲖"
      it_should_truncate_bytes "no html text with shorter length, no tail", with: {count_bytes: true, max_length: 7, tail: ''}, source: "𠝹𠝹𠝹𠝹𠝹𠝹𠝹𠝹", expected: "𠝹"
      it_should_truncate_bytes "no html text with shorter length, with tail", with: {count_bytes: true, max_length: 7}, source: "𠝹𠝹", expected: "𠝹..."
    end
    ...
    describe "html tags structure" do
      it_should_truncate_bytes "html text with tag", with: {count_bytes: true, max_length: 14}, source: "<p>some text</p>", expected: "<p>some...</p>"

      it_should_truncate_bytes "html text with nested tags (first node)", with: {count_bytes: true, max_length: 22},
                         source: "<div><p>some text 1</p><p>some text 2</p></div>",
                         expected: "<div><p>s...</p></div>"

      it_should_truncate_bytes "html text with nested tags (second node)", with: {count_bytes: true, max_length: 46},
                         source: "<div><p>some text 1</p><p>some text 2</p></div>",
                         expected: "<div><p>some text 1</p><p>some te...</p></div>"

      it_should_truncate_bytes "html text with nested tags (empty contents)", with: {count_bytes: true, max_length: 14},
                         source: "<div><p>some text 1</p><p>some text 2</p></div>",
                         expected: "<div>...</div>"

      it_should_truncate_bytes "html text with special html entities", with: {count_bytes: true, max_length: 15},
                         source: "<p>&gt;some text</p>",
                         expected: "<p>&gt;s...</p>"

      it_should_truncate_bytes "html text with siblings tags", with: {count_bytes: true, max_length: 64},
                         source: "<div>some text 0</div><div><p>some text 1</p><p>some text 2</p></div>",
                         expected: "<div>some text 0</div><div><p>some text 1</p><p>som...</p></div>"

      it_should_truncate_bytes "html with unclosed tags", with: {count_bytes: true, max_length: 151},
                         source: "<table><tr><td>Hi <br> there</td></tr></table>",
                         expected: "<table><tr><td>Hi <br/> there</td></tr></table>"

      it_should_truncate_bytes "sdasd", with: {count_bytes: true, max_length: 100},
                         source: "<span>Foo&nbsp;Bar</span>", expected: "<span>Foo#{NBSP}Bar</span>"
    end
    ...
    describe "single html tag elements" do
      it_should_truncate_bytes "html text with <br /> element without adding a closing tag", with: {count_bytes: true, max_length: 30},
                         source: "<div><h1><br/>some text 1</h1><p>some text 2</p></div>",
                         expected: "<div><h1><br/>so...</h1></div>"

      it_should_truncate_bytes "html text with <img/> element without adding a closing tag", with: {count_bytes: true, max_length: 45},
                         source: "<div><p><img src='some_path'/>some text 1</p><p>some text 2</p></div>",
                         expected: "<div><p><img src='some_path'/>so...</p></div>"
    end

    describe "comment html element" do
      it_should_truncate_bytes "html text and ignore <!-- a comment --> element by default", with: {count_bytes: true, max_length: 18},
                         source: "<!-- a comment --><p>some text 1</p>",
                         expected: "<p>some text 1</p>"

      it_should_truncate_bytes "html text with <!-- a comment --> element", with: {count_bytes: true, max_length: 35, comments: true},
                         source: "<!-- a comment --><p>some text 1</p>",
                         expected: "<!-- a comment --><p>some te...</p>"

      it_should_truncate_bytes "html text with <!-- a comment --> element that exceeds the max length", with: {count_bytes: true, max_length: 12, comments: true},
                         source: "<!-- a comment --><p>some text 1</p>",
                         expected: "<!-- a...-->"

      it_should_truncate_bytes "html text with <!-- a comment --> element with other elements that exceeds max length", with: {count_bytes: true, max_length: 28, comments: true},
                         source: "<!-- a comment --><p>some text 1</p>",
                         expected: "<!-- a comment --><p>...</p>"
    end

    describe "html attributes" do
      it_should_truncate_bytes "html text with 1 attributes", with: {count_bytes: true, max_length: 23},
                         source: "<p attr1='1'>some text</p>",
                         expected: "<p attr1='1'>som...</p>"

      it_should_truncate_bytes "html text with 2 attributes", with: {count_bytes: true, max_length: 33},
                         source: "<p attr1='1' attr2='2'>some text</p>",
                         expected: "<p attr1='1' attr2='2'>som...</p>"

      it_should_truncate_bytes "html text with attributes in nested tags", with: {count_bytes: true, max_length: 35},
                         source: "<div><p attr1='1'>some text</p></div>",
                         expected: "<div><p attr1='1'>some...</p></div>"

      it_should_truncate_bytes "html text with attribute containing entities respecting them", with: {count_bytes: true, max_length: 28, filtered_attributes: ['attr2']},
                         source: "<p attr1='&gt;some'>some text</p>",
                         expected: "<p attr1='&gt;some'>s...</p>"

      it_should_truncate_bytes "html text with 2 attributes filtering one of them", with: {count_bytes: true, max_length: 90, filtered_attributes: ['attr2']},
                         source: "<p attr1='1'>some text</p><p attr2='2'>filtered text</p>",
                         expected: "<p attr1='1'>some text</p><p>filtered text</p>"


      it_should_truncate_bytes "html text with 2 attributes filtering all of them", with: {count_bytes: true, max_length: 13, filtered_attributes: ['attr1', 'attr2']},
                         source: "<p attr1='1' attr2='2'>some text</p>",
                         expected: "<p>som...</p>"
    end

    describe "excluded tags" do
      it_should_truncate_bytes "html text with a filtered tag", with: {count_bytes: true, max_length: 90, filtered_tags: %w(img)},
                         source: "<p><img/>some text</p>",
                         expected: "<p>some text</p>"

      it_should_truncate_bytes "html text with a filtered tag with nested tags", with: {count_bytes: true, max_length: 90, filtered_tags: %w(table img)},
                         source: "<div><table><tr>Hi there</tr></table>some text<img/></div>",
                         expected: "<div>some text</div>"

      it_should_truncate_bytes "html text with a filtered tag with nested tags where nested tags are filtered", with: {count_bytes: true, max_length: 90, filtered_tags: %w(table tr img)},
                         source: "<div><table><tr><td>Hi there</td></tr></table>some text<img/></div>",
                         expected: "<div>some text</div>"
    end
  end
